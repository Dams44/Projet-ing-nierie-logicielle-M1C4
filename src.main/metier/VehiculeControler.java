...
/**
 * Classe VehiculeControler. Cette classe définit les méthodes du véhicule EV3.
 * 
 * @version 1.0
 */
public class VehiculeControler {
	 ...
	 * @param vitesseMax   : correspond à la vitesse maximum que peut atteindre le
	...
	public void forward(int vitesseAjout, int vitesseMax) {
		...
		if (!capteurPresence.obstacleDetect()) {
			...
			if (etatVehicule == Etat.neutral) {
				...
				if (moteurGauche.getVitesse() + vitesseAjout < vitesseMax
						&& moteurDroit.getVitesse() + vitesseAjout < vitesseMax) {
					moteurGauche.getMotorLejos().startSynchronization();
				...
				// Si il était en marche arrière alors, on le fait passer à nouveau en etat
				// forward.
	...
	public void arret() {
		...
		vitesse = 0;
		etatVehicule = Etat.neutral;
		System.out.println("--------arret de moteur: etat neutral--------");
	}
	...
	public void left(int vitesseAjout, int vitesseMax) {
		// Si le moteur est en marche avant ou en marche arrière, alors on fait tourner
	...
	/**
	 * Methode permettant de faire avance le robot en avant avec une légère
	...
	public void leftForward(int vitesseAjout, int vitesseMax) {
		// On augmente plus la vitesse de rotation du moteur droit par rapport a celui
		// du moteur gauche.
		// A la différence des méthode pour tourner, la différence d'accélaration des
	...
	/**
	 * Methode permettant de faire reculer le robot en arrire avec une légère
	 * trajectoire vers la gauche. (Diagonale gauche arrière)
	 * 
	 * @param vitesseAjout : correspond à la vitesse qu'on incrémente au moteur
	 * @param vitesseMax   : correspond à la vitesse maximum que peut atteindre le
	 *                     robot en marche avant.
	...
	/**
	 * Methode permettant de faire reculer le robot en arrire avec une légère
	 * trajectoire vers la droite. (Diagonale droite arrière)
	 * 
	 * @param vitesseAjout : correspond à la vitesse qu'on incrémente au moteur
	 * @param vitesseMax   : correspond à la vitesse maximum que peut atteindre le
	 *                     robot en marche avant.
