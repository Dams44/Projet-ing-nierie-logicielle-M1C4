...
* Cette classe d�finit les m�thodes du v�hicule EV3.
* @version 1.0
*/
public class VehiculeControler {
	 ...
	 * @param vitesseAjout : correspond � la vitesse qu'on incr�mente au moteur
	 * @param vitesseMax : correspond � la vitesse maximum que peut atteindre le robot en marche avant.
	 */
	public void forward(int vitesseAjout,int vitesseMax) {
		...
		if(!capteurPresence.obstacleDetect()) {
			...
			if (etatVehicule == Etat.neutral) {
				...
				//Si il �tait en marche arri�re alors, on le fait passer � nouveau en etat forward.
	...
	/**
	 * Methode permettant d'arreter le v�hicule en stoppant les deux moteurs.
	 */
	public void arret() {
		moteurGauche.getMotorLejos().startSynchronization();
		moteurGauche.stopped();
	...
	/**
	 * Methode permettant de faire avance le robot en avant avec une l�g�re trajectoire vers la gauche. (Diagonale gauche avant)
	 * @param vitesseAjout : correspond � la vitesse qu'on incr�mente au moteur
	 * @param vitesseMax : correspond � la vitesse maximum que peut atteindre le robot en marche avant.
	 */
	public void leftForward(int vitesseAjout,int vitesseMax) {
		//On augmente plus la vitesse de rotation du moteur droit par rapport a celui du moteur gauche.
		//A la diff�rence des m�thode pour tourner, la diff�rence d'acc�laration des deux moteurs est moins grande.
	...
	/**
	 * Methode permettant de faire avance le robot en avant avec une l�g�re trajectoire vers la droite. (Diagonale droite avant)
	 * @param vitesseAjout : correspond � la vitesse qu'on incr�mente au moteur
	 * @param vitesseMax : correspond � la vitesse maximum que peut atteindre le robot en marche avant.
	 */
	...
	/**
	 * Methode permettant de faire reculer le robot en arrire avec une l�g�re trajectoire vers la gauche. (Diagonale gauche arri�re)
	 * @param vitesseAjout : correspond � la vitesse qu'on incr�mente au moteur
	 * @param vitesseMax : correspond � la vitesse maximum que peut atteindre le robot en marche avant.
	 */
	...
	/**
	 * Methode permettant de faire reculer le robot en arrire avec une l�g�re trajectoire vers la droite. (Diagonale droite arri�re)
	 * @param vitesseAjout : correspond � la vitesse qu'on incr�mente au moteur
	 * @param vitesseMax : correspond � la vitesse maximum que peut atteindre le robot en marche avant.
	 */
